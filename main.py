...
save_button = tkinter.Button(
    root, text="Save To-Do List", bg="white", width=15, command=save_act)
save_button.grid(row=10, column=1)

load_button = tkinter.Button(
    root, text="Load Last To-Do List", bg="white", width=15, command=load_act)
